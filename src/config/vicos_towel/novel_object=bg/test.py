...
args = dict(
	...
	dataset={
		...
		'kwargs': {
			...
			'type': 'test_novel_object=bg',
			'subfolders': [dict(folder='bg=festive_tablecloth', data_subfolders=['cloth=big_towel','cloth=checkered_rag_big','cloth=checkered_rag_medium', 'cloth=linen_rag','cloth=small_towel','cloth=towel_rag','cloth=waffle_rag','cloth=waffle_rag_stripes']),
						   ],
